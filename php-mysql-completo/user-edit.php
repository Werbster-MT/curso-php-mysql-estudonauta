...
<body>
    ...
    <div id="corpo">
        <?php 
            if(!is_logado()) {
                echo msg_erro("<div>Efetue <a href='user-login.php'>login</a> para poder editar seus dados.</div>");
                ...
                if (!isset($_POST['usuario'])) {
                    ...
                    if ($banco -> query($q)) {
                        ...
                        logout();
                        echo msg_aviso("<div> Por segurança, efetue o <a href='user-login.php'>login</a> novamente.</div>");
                    } else {
